      ...
      >
        <div class="members-wrapper">
          <div
              ...
              :key="index"
              class="member">
            <div class="member-photo" v-if="item.image" :style="{background: `url(http://${item.image.fields.file.url.slice(2)}?w=1280&h=800) no-repeat center / cover`}">
              <div class="socials">
                <a :href="item.instagram" class="socials-instagram"></a>
                <a :href="item.facebook" class="socials-facebook"></a>
              </div>
            </div>
            <div class="member-photo-retina" v-if="item.image" :style="{background: `url(http://${item.image.fields.file.url.slice(2)}) no-repeat center / cover`}">
              <div class="socials">
                <a :href="item.instagram" class="socials-instagram"></a>
                <a :href="item.facebook" class="socials-facebook"></a>
              </div>
            </div>
            <div class="member-photo member-photo-mobile" v-if="item.imageMobile" :style="{background: `url(http://${item.imageMobile.fields.file.url.slice(2)}) no-repeat center / cover`}">
              <div class="socials">
                <a :href="item.instagram" class="socials-instagram"></a>
                <a :href="item.facebook" class="socials-facebook"></a>
              </div>
